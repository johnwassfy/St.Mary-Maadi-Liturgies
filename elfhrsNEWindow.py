...
class elfhrswindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.add_buttons_with_paths(
            ["سنوي أيام","سنوي آحاد", "صوم نينوى", "الصوم الكبير", "احد الشعانين", "الخماسين - القداس", "السنكسار (عناوين فقط)"
            ], 
            [
             "Data\القطمارس\القطمارس السنوي ايام.pptx", 
             "Data\القطمارس\القطمارس السنوي احاد.pptx",
             "Data\القطمارس\الصوم الكبير و صوم نينوى\قرائات صوم نينوى و فصح يونان.pptx", 
             "Data\القطمارس\الصوم الكبير و صوم نينوى\قطمارس الصوم الكبير.pptx", 
             "Data\القطمارس\قرائات احد الشعانين.pptx",
